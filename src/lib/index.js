        ...
        if (
            ...
            for (const [ memberId, presence ] of listedPresences) {     
                ...
                if (hasRole && text !== name) {
                    member.roles.remove(role, 'discord.gg/bottr - Bot TR\'s')
                    .then(() => {
                        channel.send({
                            embeds: [
                                new EmbedBuilder()
                                ...
                                .setTimestamp()
                                .setFooter({ text: 'Bu proje discord.gg/bottr sunucusundan alınmıştır.', iconURL: 'https://i.hizliresim.com/cau9e3b.gif' }),
                            ],
                          });
                        })
                        .catch(() => undefined);
                ...
                member.roles.add(role, 'discord.gg/bottr - Bot TR\'s')
                    .then(() => {
                        channel.send({
                            embeds: [
                                new EmbedBuilder()
